defmodule RememblyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RememblyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RememblyWeb.Gettext, "errors", msg, opts)
    end
  end
